...
/*
  ...
  Extracted so /blog/<slug> and /es/blog/<slug> cannot drift — the whole point of
  translating a guide is that it is the same guide. The routes keep what is
    ...
    <>
        <article className="max-w-3xl mx-auto px-6 md:px-8 py-12 md:py-16">
          ...
          {/* The index sits above the body, not floating beside it: at 720px of
              ...
              the fourth. */}
          <TableOfContents value={post.body} locale={locale} />
          ...
          <aside className="mt-14 bg-card border border-line rounded-3xl p-7 text-center">
            ...
            */}
            <div className="flex flex-wrap items-center justify-center gap-3 mt-5">
              ...
              <a
                href={mailtoLink(`${t.emailSubject}: ${post.title}`)}
        ...
        {related.length > 0 ? (
          <section className="max-w-6xl mx-auto px-6 md:px-8 pb-16 md:pb-20">
            <h2 className="font-display font-semibold text-ink text-2xl mb-6">{t.keepReading}</h2>
