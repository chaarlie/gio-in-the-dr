...
const PROPERTIES: Property[] = [
  { id: "p1", name: "Sunrise Villa", city: "Cabarete", category: "Villas", price: "$1.2M", spec: "4 Bed · 5 Bath · Private Pool" },
  { id: "p2", name: "Kite Beach Condo", city: "Cabarete", category: "Beachfront Condos", price: "$395K", spec: "2 Bed · Beachfront · 40m to sand" },
  { id: "p3", name: "Sosúa Ocean Villa", city: "Sosúa", category: "Luxury Properties", price: "$680K", spec: "3 Bed · Ocean view" },
  { id: "p4", name: "Cabrera Ocean-View Land", city: "Cabrera", category: "Investment Properties", price: "$290K", spec: "2,400 m² · Building lot" },
  { id: "p5", name: "Encuentro Pre-Sale Condo", city: "Cabarete", category: "Pre-Construction", price: "$310K", spec: "2 Bed · Delivery 2027" },
  { id: "p6", name: "Sosúa Financed Condo", city: "Sosúa", category: "Owner Financing Opportunities", price: "$225K", spec: "Owner financing · 30% down" },
];
  ...
  return (
    <section id="properties" className="scroll-mt-24 max-w-7xl mx-auto px-6 md:px-8 pt-12 sm:pt-16 pb-4">
      <div className="text-center mb-8">
        <h2 className="font-display font-bold text-ink text-3xl md:text-5xl">Properties</h2>
        <p className="text-muted mt-3">
          Beachfront condos, villas, investment and pre-construction across the north coast.
        </p>
      </div>
          ...
          {filtered.map((p) => (
            ...
            >
              ...
              <div className="absolute top-4 left-4 right-4 flex justify-between items-start gap-2">
                ...
                {/* Bigger price button */}
                <span className="bg-cream text-ink text-base font-bold px-4 py-2 rounded-full shadow-sm shrink-0">
                  {p.price}
                </span>
              </div>
